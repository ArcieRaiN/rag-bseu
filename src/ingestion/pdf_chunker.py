...
"""
Чанкинг PDF-документов через LlamaIndex PDFReader.

Стратегия: один Chunk = одна страница PDF.
Подходит для статистических таблиц и отчётов,
где табличные данные обычно не разрываются между страницами.
"""
