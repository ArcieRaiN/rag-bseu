...
Обеспечивает хранение, добавление и удаление эмбеддингов чанков.
Cosine similarity достигается через IndexFlatIP с нормализованными векторами.
IndexIDMap2 позволяет удалять чанки по идентификатору при обновлении PDF.
"""
