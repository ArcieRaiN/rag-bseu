...
"""
Обработка пользовательских запросов через гибридный поиск.

Этапы:
  1. Обогащение запроса (embedding + regex: years/geo, без LLM)
  2. Гибридный поиск (Semantic + BM25 + Metadata) → RRF → Top-K
